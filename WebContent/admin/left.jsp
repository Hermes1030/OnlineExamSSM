    ...
    <link rel="stylesheet" type="text/css" href="${path }/js/zeroModal/zeroModal.css"/>
     	...
     	<style type="text/css">
    		...
    		*{font-family:'微软雅黑';font-size:12px;color:#626262;}
    		...
    		/*left*/
    		.leftsidebar_box{width:200px;height:auto !important;overflow:visible !important;position:fixed;height:100% !important;background-color:#F9F9F9;margin-left: -15px;border-right: 2px solid #E5E5E5;}
    		.line{height:2px;width:100%;background-image:url(../images/left/line_bg.png);background-repeat:repeat-x;}
    		.leftsidebar_box dl{border-bottom: 1px solid #E5E5E5; border-color: #FCFCFC -moz-use-text-color #E5E5E5;}
    		.leftsidebar_box dt{padding-left:44px;padding-right:12px;background-repeat:no-repeat;background-position:10px center;color:#585858;font-size:18px;position:relative;line-height:52px;cursor:pointer;}
    		.leftsidebar_box dd{background-color:#FFFFFF;padding-left:40px;}
    		.leftsidebar_box dd a{color:#585858;line-height:35px;font-size: 15px;}
...
<c:if test="${power == 0 }">
    <c:set var="classId" value="${sessionScope.classId}"></c:set>
</c:if>
...
<div class="container" >
    		<div class="leftsidebar_box">
    			...
    			<dl class="channel">
                    ...
                    <c:if test="${power == 0}">
                        <dd class="first_dd"><a href="../students?classId=${classId}" target="right" id="10" class="handle-view">&emsp;学生信息&emsp;&emsp;&emsp;</a></dd>
                ...
                <c:if test="${power == 0}">
                    ...
                    <dl class="source">
                        ...
                        <dd class="first_dd"><a href="../historys?classId=${classId}" target="right" id="10" class="handle-view">&emsp;学生记录&emsp;&emsp;&emsp;</a></dd>
                    </dl>
                </c:if>
    		</div>
