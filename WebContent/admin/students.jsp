					...
					<li>
						<div style="width:-1%; height:100%;float:right;">
							<form action="students" id="scannerPageForm">
								<input id="scannerPage" type="text" name="startPage" style="width: 40px;height: 33px;border: 1px solid gray;border-radius: 3px;" />
								<input class="btn btn-default goPage" type="submit" value="Go" style="margin-left: -4px;margin-bottom: 1.3px;height: 33px;" />
							</form>
						</div>
					</li>
				</ul>
