...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-8 column">
            <form class="form-horizontal" role="form" action="dispatcherUpload" method="post"
                  enctype="multipart/form-data">
                <div class="form-group">
                    <label for="division" class="col-sm-2 control-label">是否分科</label>
                    <div class="col-sm-10">
                        <select id="division" class="selectpicker" name="division" id="division"
                ...
                <div class="form-group">
                    <%--@declare id="importchoose"--%><label for="importChoose"
                                                             class="col-sm-2 control-label">选项</label>
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" name="importOption" id="only-subject" value="0" checked="checked"/>
                            只导入试题
                        </label>
<%--                        <label class="radio-inline">--%>
...
<%--                        </label>--%>
						...
						<b class="tips">题目</b>|<b class="tips">答案A-D</b>|<b class="tips">正确答案</b>|<b
                                    class="tips">分值</b>|<b class="tips">试题类型</b>|<b class="tips">难易程度</b>
						与其列对应, 第一行标题名不得有误, 否则将无法解析; </span>
                    </div>
                </div>
...
<%--                    <div class="col-sm-10">--%>
<%--                        <input class="form-control" name="examPaperName" id="examPaperName" type="text"--%>
<%--                               placeholder="新建试卷名称"/>--%>
<%--                    </div>--%>
<%--                </div>--%>
<%--                <div class="form-group importToNewPaper">--%>
...
<%--                    <div class="col-sm-10">--%>
<%--                        <input class="form-control" name="examPaperTime" id="examPaperTime" type="text"--%>
<%--                               placeholder="新建试卷考试时长"/>--%>
<%--                    </div>--%>
<%--                </div>--%>
                <div class="form-group">
