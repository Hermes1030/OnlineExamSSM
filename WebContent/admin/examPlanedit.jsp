                ...
                <form class="form-horizontal" role="form" id="examPlanAction" action="examPlan" method="post">
                    <c:if test="${examPlan.examPlanId != null }">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" id="examPlanId" name="examPlanId" type="text"
                                       value="${examPlan.examPlanId }" readonly="readonly" unselectable='on'
                                       onfocus='this.blur()'/>
                            </div>
                        ...
                        <div class="col-sm-5">
                            <select class="selectpicker" name="clazz.classId" id="classId" data-live-search="true">
                                <c:if test="${examPlan != null }">
                                    <option value="${examPlan.clazz.classId }"
                                            style="display: none;">${examPlan.clazz.className }</option>
                                </c:if>
                                <%--获取当前老师的班级Id--%>
                                <c:forEach items="${classes }" var="clazz">
                                    <c:if test="${clazz.classId == sessionScope.classId }">
<%--										将选项不可更改--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="selectpicker" name="course.courseId" id="courseId" data-live-search="true">
                                <c:if test="${examPlan != null }">
                                    <option value="${examPlan.course.courseId }"
                                            style="display: none;">${examPlan.course.courseName }</option>
                                </c:if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="selectpicker" name="examPaper.examPaperId" id="examPaperId"
                                    data-live-search="true">
                                <c:if test="${examPlan != null }">
                                    <option value="${examPlan.examPaper.examPaperId }"
                                            style="display: none;">${examPlan.examPaper.examPaperName }</option>
                                </c:if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" id="beginTime" name="beginTime" id="beginTime"
                                   value="${examPlan.beginTime }"/>
                        </div>
                    </div>
                    <br/>
                    <div class="form-group">
