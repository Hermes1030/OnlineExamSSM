...
public class TeacherInfoServiceImpl implements TeacherInfoService {
	...
	//通过teacherid查询classid
	public int getClassIdByTeacherId(int teacherId) {return teacherInfoMapper.getClassIdByTeacherId(teacherId);}
	public String getClassNameByClassId(Integer calssId){
		return teacherInfoMapper.getClassNameByClassId(calssId);
	}
}
